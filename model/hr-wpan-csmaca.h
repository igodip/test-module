 ...
 */
typedef Callback<void, HrWpanMacState> HrWpanMacStateCallback;

/**
 * \ingroup hr-wpan
 *
 * This class is a helper for the HrWpanMac to manage the Csma/CA
...
public:
   ...
   */
  void SetHrWpanMacStateCallback (HrWpanMacStateCallback macState);
...
private:
   ...
   */
  HrWpanCsmaCa (HrWpanCsmaCa const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  HrWpanCsmaCa& operator= (HrWpanCsmaCa const &);
   ...
   */
  HrWpanMacStateCallback m_hrWpanMacStateCallback;
