...
namespace ns3 {
	...
	namespace HrWpan
	{
		...
		typedef double PhyPibCCATreshold;
		...
		*/
		...
		}PhyCurrentRegDomainEnumeration;
		...
		*/
		...
		struct PhyPIBAttributes {
			PhyCurrentChannelEnumeration channelEnum;
