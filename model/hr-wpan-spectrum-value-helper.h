 ...
 */
#ifndef HR_WPAN_SPECTRUM_VALUE_HELPER_H
#define HR_WPAN_SPECTRUM_VALUE_HELPER_H
 ...
 * \ingroup lr-wpan
 *
 * \brief This class defines all functions to create spectrum model for HrWpan
 */
class HrWpanSpectrumValueHelper
{
public:
  HrWpanSpectrumValueHelper (void);
  virtual ~HrWpanSpectrumValueHelper (void);
...
#endif /*  HR_WPAN_SPECTRUM_VALUE_HELPER_H */
