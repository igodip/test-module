 ...
 * accessing the HrWpanMac pointer to make 802.15.4-specific API calls.
...
public:
   ...
   */
  Ptr<HrWpanCsmaCa> GetCsmaCa (void) const;
  ...
  /**
   * This method indirects to HrWpanMac::SetShortAddress ()
   */
