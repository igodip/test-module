	...
	namespace HrWpan 
	{
		...
		*/
		...
		public:
			...
			*/
			MacHeader(enum FrameType wpanMacType,      // Data, ACK, Control MAC Header must have
			...
			*/
			enum FrameType GetType(void) const;
			/**
			...
			*/
			void SetType(enum FrameType wpanFrameType);
			...
			*/
			void SetAckPolicyType(enum AckPolicy ackPolicy);
			/**
			*	Get the Ack Policy type
			*
			*/
			enum AckPolicy GetAckPolicyType(void) const;
