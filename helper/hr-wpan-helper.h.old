...
class HrWpanHelper : public PcapHelperForDevice,
                     public AsciiTraceHelperForDevice
{
public:
  /**
   * \brief Create a HrWpan helper in an empty state.  By default, a
  ...
  /**
   * \brief Create a HrWpan helper in an empty state with either a
   ...
   */
  void AddMobility (Ptr<HrWpanPhy> phy, Ptr<MobilityModel> m);

  /**
   * \brief Install a HrWpanNetDevice and the associated structures (e.g., channel) in the nodes.
  ...
  /**
   * Helper to enable all HrWpan log components with one statement
   */
  void EnableLogComponents (void);

  /**
   * \brief Transform the HrWpanPhyEnumeration enumeration into a printable string.
   * \param e the HrWpanPhyEnumeration
   * \return a string
   */
  static std::string HrWpanPhyEnumerationPrinter (HrWpanPhyEnumeration e);

  /**
   * \brief Transform the HrWpanMacState enumeration into a printable string.
   * \param e the HrWpanMacState
   * \return a string
   */
  static std::string HrWpanMacStatePrinter (HrWpanMacState e);
...
private:
   ...
   */
  HrWpanHelper (HrWpanHelper const &);
  /**
   * \brief Copy constructor - defined and not implemented.
   * \returns
   */
  HrWpanHelper& operator= (HrWpanHelper const &);
  /**
